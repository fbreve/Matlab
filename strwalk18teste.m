...
function [owner, pot, owndeg, distnode] = strwalk18teste(X, slabel, k, disttype, pdet, deltav, nclass, iter)
    ...
    for chi=1:npart;
        ...
        for i=1:npart
            if partnode(i)~=0 
                ...
                partpos(j)=partnode(i); % volta partícula para casa
            end
        end
        ...
        % associa partícula à nova casa
        partnode(indpartminownowndeg) = indnodencmaxowndeg;
