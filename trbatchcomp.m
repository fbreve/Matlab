...
for subset=13:1:subsetmax
    ...
    disp(sprintf('Partículas     - Subset: %02.0f  K: %0.4f  Acerto: %0.4f  Kappa: %0.4f',subset,gaout,tab_acc(subset,4),tab_kap(subset,4)))
    disp(sprintf('Partículas (F) - Subset: %02.0f  K: %0.4f  Acerto: %0.4f  Kappa: %0.4f',subset,gaout,tab_acc(subset,5),tab_kap(subset,5)))
