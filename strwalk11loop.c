...
{ 
    ...
    strwalk11loop(maxiter,npart,nclass,stopmax,pdet,dexp,deltav,deltap,potmin,partpos,partclass,potpart,slabel,nsize,distnode,nlist,pot,qtnode,neibmax);
