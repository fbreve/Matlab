% Semi-Supervised Territory Mark Walk v.7
...
% Usage: [owner, pot, distnode] = strwalk7(X, slabel, nclass, iter, pdet, deltav, deltap, sigma, dexp)
function [owner, pot, distnode] = strwalk7(X, slabel, nclass, iter, pdet, deltav, deltap, sigma, dexp)
