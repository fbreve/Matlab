/*=================================================================
 *
 *ESCALARES (int): npart, nclass, stopmax
...
#define	npart_IN        prhs[0]
#define	nclass_IN       prhs[1]
#define	stopmax_IN      prhs[2]
#define	pdet_IN         prhs[3]
#define	dexp_IN         prhs[4]
#define	deltav_IN       prhs[5]
#define	deltap_IN       prhs[6]
#define potmin_IN       prhs[7]
#define partpos_IN      prhs[8]
#define partclass_IN 	prhs[9]
#define potpart_IN      prhs[10]
#define slabel_IN       prhs[11]
#define nsize_IN        prhs[12]
#define distnode_IN     prhs[13]
#define nlist_IN        prhs[14]
#define pot_IN          prhs[15]
#define owndeg_IN       prhs[16]
...
#define distnode_OUT    plhs[2]

static void strwalk15loop(
            int npart, 
            int nclass, 
            int stopmax,
            double pdet,
...
{ 
    ...
    int npart, nclass, stopmax; // escalares int
    ...
    distnode_OUT = distnode_IN;
        
    strwalk15loop(npart,nclass,stopmax,pdet,dexp,deltav,deltap,potmin,partpos,partclass,potpart,slabel,nsize,distnode,nlist,pot,owndeg,qtnode,neibmax);
