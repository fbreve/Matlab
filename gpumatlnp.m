...
% Uso: owner = gpulnp(X,slabel,nclass,iter,alpha,k)
...
function owner = gpulnp(X,slabel,k,alpha,nclass,iter)
...
[~,IX] = sort(squareform(pdist(X,'euclidean').^2)); % índices dos vizinhos mais próximos (distância euclidiana nao normalizada)
