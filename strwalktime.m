...
% partícula
% Usage: [owner, pot, t, i] = strwalktime(X, label, slabel, npart, iter, reset, pdet, deltav, deltap, sigma)
function [owner, pot, t, i] = strwalktime(X, label, slabel, npart, iter, reset, pdet, deltav, deltap, sigma)
    if (nargin < 10) || isempty(sigma),
