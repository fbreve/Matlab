...
% Usage: [owner, owner2, potval, owndeg] = strwalk30(img, imgslab, k, disttype, valpha, pgrd, deltav, deltap, dexp, maxiter)
% INPUT:
...
function [owner, owner2, potval, owndeg] = strwalk30(img, imgslab, k, disttype, valpha, pgrd, deltav, deltap, dexp, maxiter)
    ...
    %dmmean = abs(mean(X(slabel==1,:))-mean(X(slabel==2,:)));
