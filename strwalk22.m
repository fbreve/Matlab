  ...
  % variável para guardar máximo potencial mais alto médio
    ...
    for i=1:maxiter
        ...
        for j=1:npart
            ...
            nt = find(prob>=(roulettepick(j)*prob(end)),1,'first'); % índice do vizinho alvo na lista de vizinhos do nó atual
            k = Nlist(ppj,nt); % índice do vizinho alvo no vetor de nós
