% Complex Networks Semi-Supervised Learning Image Segmentation v4
...
% Usage: [owner, pot] = cnsslis4(img, imgslab, fw, k, disttype, valpha, maxiter)
% INPUT:
...
function [owner, pot] = cnsslis4(img, imgslab, fw, k, disttype, valpha, maxiter)
...
if k>0
    ...
    potval = cnsslis4loop(maxiter,nnonlabeled,indnonlabeled,stopmax,potval,k,KNN);
    clear KNN slabelval;
