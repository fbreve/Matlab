...
% Usage: [owner, pot, owndeg, distnode] = strwalk8g(graph, slabel, pdet, deltav, deltap, dexp, nclass, iter)
function [owner, pot, owndeg, distnode] = strwalk8g(graph, slabel, pdet, deltav, deltap, dexp, nclass, iter)
