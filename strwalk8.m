...
% ou não normalizada
% Unificar versões: quarto parâmetro para escolher se quinto parâmetro será
% k ou sigma
...
% Usage: [owner, pot, owndeg, distnode] = strwalk8(X, slabel, sigma, disttype, pdet, deltav, deltap, dexp, nclass, iter)
function [owner, pot, owndeg, distnode] = strwalk8(X, slabel, sigma, disttype, pdet, deltav, deltap, dexp, nclass, iter)   
