...
% Sem critério de parada (v.8ko)
% Usage: [owner, pot, owndeg, distnode] = strwalk8ko(X, slabel, k, disttype, pdet, deltav, deltap, dexp, nclass, iter)
function [owner, pot, owndeg, distnode] = strwalk8ko(X, slabel, k, disttype, pdet, deltav, deltap, dexp, nclass, iter)
