...
% Usage: [owner, slabel, pot, owndeg, distnode] = strwalk15mex(X, label, labp, k, disttype, valpha, pdet, deltav, deltap, dexp, nclass)
function [owner, slabel, pot, owndeg, distnode] = strwalk15mex(X, label, labp, k, disttype, valpha, pdet, deltav, deltap, dexp, nclass)
