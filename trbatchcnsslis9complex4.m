...
for i=1:10
    ...
    tab_err(i) = y;    
    imwrite(imgres,sprintf('res/imgcnsslis9complex4-%i%%-%s-err%0.4f-k%i.png',i/10*100,getenv('computername'),y,k));
    % teste de tempo
    save(sprintf('tabs_cnsslis9complex4-%s',getenv('computername')),'tab_time','tab_ph1iter','tab_ph2iter','tab_err');
end
% teste de tempo
