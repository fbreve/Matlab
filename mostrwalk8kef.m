...
% Usage: [owner, pot, owndeg, distnode] = mostrwalk8kef(X, slabel, k, pdet, deltav, deltap, dexp, nclass, iter)
function [owner, pot, owndeg, distnode] = mostrwalk8kef(X, slabel, k, pdet, deltav, deltap, dexp, nclass, iter)
