...
% Aceita diretamente a lista de vizinhos (v.8gn)
% Usage: [owner, pot, owndeg, distnode] = strwalk8gn(N, slabel, pdet, deltav, deltap, dexp, nclass, iter)
function [owner, pot, owndeg, distnode] = strwalk8gn(N, slabel, pdet, deltav, deltap, dexp, nclass, iter)
    ...
    qtnode = size(N,2); % quantidade de nós
