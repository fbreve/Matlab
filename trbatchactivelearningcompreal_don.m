...
%     disp(sprintf('Partículas Original - Rotulados: %0.2f - Erro: %0.4f - K: %2.0f',labp,fval,k))
    ...
    parfor j=1:rep
        ...
        disp(sprintf('Rotulados: %0.2f - Rep %3.0f/%3.0f - Original / Active Learning v.13 / v.14: %0.4f - %0.4f - %0.4f - K: %2.0f',labp,j,rep,part1(j),part2(j),part3(j),k))
    end   
    ...
    save tabs_activelearningcompreal_don tab_acc tab_std_acc tab_min_acc tab_max_acc;
    disp(sprintf('FINAL: Rotulados: %0.4f  Original: %0.4f  Active Learning (v.14): %0.4f (v.15): %0.4f',labp,tab_acc(i,1),tab_acc(i,2),tab_acc(i,3)))
end
