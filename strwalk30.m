...
% In: XI Workshop de Visão Computacional (WVC2015), 2015, São Carlos, SP, Brasil. 
% Proceedings - XI Workshop de Visão Computacional WVC´2015, 2015. p.164 - 169.
%
...
function [owner, owner2, potval, owndeg] = strwalk30(img, imgslab, k, wtype, disttype, valpha, pgrd, deltav, deltap, dexp, maxiter)
    ...
    if (nargin < 4) || isempty(wtype),
        wtype = 1; % quantidade de vizinhos mais próximos
    end    
