...
for i=0.1:-0.01:0.01
    ...
    disp(sprintf('Percent: %0.4f  Consistency: %0.4f  Label Prop: %0.4f  Particle: %0.4f  Particle2: %0.4f',i,tab_kap(ind_x,1),tab_kap(ind_x,2),tab_kap(ind_x,3),tab_kap(ind_x,4)))
end
