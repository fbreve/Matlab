...
% Adjust feature weights automatically (v11)
% Usage: [owner, pot] = cnsslis11(img, imgslab, fwtype, k, sigma, disttype, valpha, maxiter)
% INPUT:
...
% fw        - feature weight type of measure
...
function [owner, pot] = cnsslis11(img, imgslab, fwtype, k, sigma, disttype, valpha, maxiter)
...
if k>0
    ...
    [rs_dim,qtnode,X,slabel,nodeval,nclass] = getFeatures(rs_img,rs_imgslab,fwtype);        
...
[dim,qtnode,X,slabel,nodeval,nclass] = getFeatures(img,imgslab,fwtype);
...
function [dim,qtnode,X,slabel,nodeval,nclass] = getFeatures(img,imgslab,fwtype)
