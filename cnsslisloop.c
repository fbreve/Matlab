    ...
    for(int i=0; i<maxiter; i++)
    {
        ...
        {            
            ...
            {           
                ...
                int neib = (int) (nlist[ppj + k*qtnode]-1);                
...
{    
    ...
    double *nsize,*indnonlabeled; // vetores de int
    ...
    indnonlabeled = mxGetPr(indnonlabeled_IN);
