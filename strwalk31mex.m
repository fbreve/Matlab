...
function [owner, pot, owndeg] = strwalk31mex(X, slabel, k, disttype, valpha, deltav, deltap, dexp, nclass, maxiter)
    ...
    [pot, owndeg] = strwalk31loop(maxiter, npart, nclass, stopmax, dexp, deltav, deltap, potmin, partpos, partclass, potpart, slabel, knns, distnode, KNN, pot, owndeg);
    [~,owner] = max(pot,[],2);
