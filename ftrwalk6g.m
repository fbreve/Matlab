% Fuzzy Territory Mark Walk v.6 (versão para grafos prontos)
...
% v.6 -> calcula kernel de cada cluster (nao na versao grafo pronto), incorpora otimizações de strwalk8
% v.6 -> incorpora reset
