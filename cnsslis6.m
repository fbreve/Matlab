% Complex Networks Semi-Supervised Learning Image Segmentation v6
...
% Primeira fase sem redimensionar imagem (v6)
% Usage: [owner, pot] = cnsslis6(img, imgslab, fw, k, disttype, valpha, maxiter)
% INPUT:
...
function [owner, pot] = cnsslis6(img, imgslab, fw, k, disttype, valpha, maxiter)
