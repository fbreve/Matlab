...
% Usage: [owner, pot, owndeg, distnode] = strwalk8k(X, slabel, k, disttype, valpha, pgrd, deltap, dexp, nclass, maxiter)
% INPUT:
...
function [owner, pot] = strwalk23mex(X, slabel, k, disttype, valpha, nclass, maxiter)
    ...
    pot = strwalk23loop(maxiter, npart, nclass, stopmax, partnode, slabel, knns, KNN, pot);
    [~,owner] = max(pot,[],2);
