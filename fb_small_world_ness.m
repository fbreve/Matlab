% Changed reachdist to MATLAB graph 'distances' function, which is less
% memory consuming (F.B.)
function [S,C,L] = fb_small_world_ness(A,LR,CR,FLAG)
...
G = digraph(A);
D = distances(G);  % returns Distance matrix of all pairwise distances
