...
for i=i_start:1:50
    ...
    % grave imagem
    imwrite(imgres,sprintf('res/imgcnsslis9feat-%s-%s-err%0.4f-k%i.png',imgname,getenv('computername'),y,k));
    dlmwrite(sprintf('res/imgcnsslis9feat-%s-%s-err%0.4f-k%i.txt',imgname,getenv('computername'),y,k),[y telapsed k]);
