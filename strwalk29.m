...
% Versão utilizada em:
% BREVE, Fabricio Aparecido; QUILES, Marcos Gonçalves; ZHAO, Liang. "Interactive Image Segmentation using Particle Competition and Cooperation"
...
function [owner, owner2, potval, owndeg] = strwalk29(img, imgslab, dm, k, disttype, slabtype, valpha, pgrd, deltav, deltap, dexp, maxiter)
