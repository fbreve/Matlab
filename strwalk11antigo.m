...
% Usage: [owner, pot, distnode] = strwalk11(X, slabel, k, disttype, pdet, deltav, deltap, dexp, nclass, iter)
function [owner, pot, distnode] = strwalk11(X, slabel, k, disttype, pdet, deltav, deltap, dexp, nclass, iter)
...
%     graph = graph - eye(qtnode);  % zerando diagonal do grafo
    ...
    for i=1:qtnode
        ...
        if slabel(i)~=0
            ...
            distnode(i,slabel(i))=0; % definindo distância do nó pré-rotulado para 0 na tabela de sua respectiva partícula            
