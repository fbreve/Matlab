...
% Usage: owner = strwalk20mexbeta(X, slabel, k, disttype, valpha, beta, pgrd, deltav, deltap, dexp, nclass, maxiter)
function owner = strwalk20mexbeta(X, slabel, k, disttype, valpha, beta, pgrd, deltav, deltap, dexp, nclass, maxiter)
    ...
    stopmax = round((qtnode/npart)*round(valpha*0.1/beta)); % qtde de iterações para verificar convergência
