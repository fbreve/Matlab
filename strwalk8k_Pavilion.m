...
% Usage: [owner, pot, owndeg, distnode] = strwalk8k(X, slabel, k, pdet, deltav, deltap, dexp, nclass, iter)
function [owner, pot, owndeg, distnode] = strwalk8k(X, slabel, k, pdet, deltav, deltap, dexp, nclass, iter)
