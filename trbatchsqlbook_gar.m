...
options = gaoptimset('Display','iter','UseParallel','always','FitnessLimit',0,'StallGenLimit',10,'Generations',25);
for subset=1:1:subsetmax
    ...
    fitfunstrwalk = @(x) fitstrwalk(x,X,slabel,label); %8ke
    ...
    parfor i=1:rep
        [owner, pot, owndeg, distnode] = strwalk8k(X, slabel, k, pdet, deltav);  % 8ke
    ...
    save tabs_sqlbook_gar tab_par tab_err tab_std_err tab_min_err tab_max_err tab_err2 tab_std_err2 tab_min_err2 tab_max_err2;
end
